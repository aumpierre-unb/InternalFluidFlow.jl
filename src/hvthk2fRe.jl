...
Compute Re and f:
```
    h=40;v=1.1e2;L=2.5e3;thk=2.7e-3; # inputs in cgs units
...
Compute Re and f:
```
    h=40;v=1.1e2;L=2.5e3;thk=2.7e-3;rho=0.989;mu=8.9e-3; # inputs in cgs units
    Re,f=hvthk2fRe(h,v,L,thk,rho,mu)
```
Compute Re and f and plot a schematic Moody diagram:
```
    Re,f=hvthk2fRe(0.40,1.1,25,2.7e-5,997,9.1e-4,9.81,true)
```
"""
