...
@doc raw"""
`Re,f=hQthk2fRe(h,Q,L,thk,g,μ,ρ[,fig])` computes
...
```
    h=40;Q=8.6e3;L=2.5e3;k=2.5e-2;g=981;μ=8.9e-3;ρ=0.989;
    Re,f=hQthk2fRe(h,Q,L,k,g,μ,ρ)
```
...
"""
function hQthk2fRe(h, Q, L, thk, g, μ, ρ, fig=false)
